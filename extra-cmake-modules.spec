...
Source0  : https://download.kde.org/stable/frameworks/5.107/extra-cmake-modules-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/extra-cmake-modules-5.107.0.tar.xz.sig
...
%prep
%setup -q -n extra-cmake-modules-5.107.0
cd %{_builddir}/extra-cmake-modules-5.107.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686495974
mkdir -p clr-build
pushd clr-build
