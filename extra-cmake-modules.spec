...
Source0  : https://download.kde.org/stable/frameworks/6.9/extra-cmake-modules-6.9.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.9/extra-cmake-modules-6.9.0.tar.xz.sig
...
%setup -q -n extra-cmake-modules-6.9.0
cd %{_builddir}/extra-cmake-modules-6.9.0
%patch -P 1 -p1
pushd ..
cp -a extra-cmake-modules-6.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735158127
mkdir -p clr-build
pushd clr-build
