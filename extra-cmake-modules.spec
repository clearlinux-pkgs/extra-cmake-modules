...
Source0  : https://download.kde.org/stable/frameworks/5.95/extra-cmake-modules-5.95.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.95/extra-cmake-modules-5.95.0.tar.xz.sig
...
%prep
%setup -q -n extra-cmake-modules-5.95.0
cd %{_builddir}/extra-cmake-modules-5.95.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655132117
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/extra-cmake-modules-5.95.0/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/extra-cmake-modules/ff3ed70db4739b3c6747c7f624fe2bad70802987
cp %{_builddir}/extra-cmake-modules-5.95.0/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/extra-cmake-modules/680ed9349d3d12bd39ddd36e8c4bc6b1b0cb1c0e
cp %{_builddir}/extra-cmake-modules-5.95.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/extra-cmake-modules/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/extra-cmake-modules-5.95.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/extra-cmake-modules/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/extra-cmake-modules-5.95.0/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/extra-cmake-modules/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/extra-cmake-modules-5.95.0/modules/ECMQmlModule.cpp.in.license %{buildroot}/usr/share/package-licenses/extra-cmake-modules/c4a1f2398de8ed1aa1ff8b696bb274a418879abd
cp %{_builddir}/extra-cmake-modules-5.95.0/modules/ECMQmlModule.h.in.license %{buildroot}/usr/share/package-licenses/extra-cmake-modules/c4a1f2398de8ed1aa1ff8b696bb274a418879abd
cp %{_builddir}/extra-cmake-modules-5.95.0/tests/ECMQmlModuleTest/qmldir_expected_depends.license %{buildroot}/usr/share/package-licenses/extra-cmake-modules/c4a1f2398de8ed1aa1ff8b696bb274a418879abd
cp %{_builddir}/extra-cmake-modules-5.95.0/tests/ECMQmlModuleTest/qmldir_expected_full.license %{buildroot}/usr/share/package-licenses/extra-cmake-modules/c4a1f2398de8ed1aa1ff8b696bb274a418879abd
cp %{_builddir}/extra-cmake-modules-5.95.0/tests/ECMQmlModuleTest/qmldir_expected_qmlonly.license %{buildroot}/usr/share/package-licenses/extra-cmake-modules/c4a1f2398de8ed1aa1ff8b696bb274a418879abd
pushd clr-build
%make_install
popd
...
/usr/share/doc/ECM/html/_sources/kde-module/KDEMetaInfoPlatformCheck.rst.txt
...
/usr/share/doc/ECM/html/kde-module/KDEMetaInfoPlatformCheck.html
