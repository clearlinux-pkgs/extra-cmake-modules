...
Source0  : https://download.kde.org/stable/frameworks/6.3/extra-cmake-modules-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/extra-cmake-modules-6.3.0.tar.xz.sig
...
%setup -q -n extra-cmake-modules-6.3.0
cd %{_builddir}/extra-cmake-modules-6.3.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717773184
mkdir -p clr-build
pushd clr-build
