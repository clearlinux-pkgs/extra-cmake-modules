...
Source0  : https://download.kde.org/stable/frameworks/6.0/extra-cmake-modules-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/extra-cmake-modules-6.0.0.tar.xz.sig
...
BuildRequires : extra-cmake-modules qt6tools-dev
BuildRequires : git
...
%prep
%setup -q -n extra-cmake-modules-6.0.0
cd %{_builddir}/extra-cmake-modules-6.0.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711118013
mkdir -p clr-build
pushd clr-build
