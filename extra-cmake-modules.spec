...
Source0  : https://download.kde.org/stable/frameworks/6.5/extra-cmake-modules-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/extra-cmake-modules-6.5.0.tar.xz.sig
...
%setup -q -n extra-cmake-modules-6.5.0
cd %{_builddir}/extra-cmake-modules-6.5.0
%patch -P 1 -p1
pushd ..
cp -a extra-cmake-modules-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723211619
mkdir -p clr-build
pushd clr-build
